...
const ArticleCard = ({ style, title, blob, id }) => {
  return (
    <div
      style={style}
      className="py-8 max-w-2xl flex items-center article-card"
    >
      <div className="svg-container article-card-gem">
        <svg
          className="house-loader h-l1"
          xmlns="http://www.w3.org/2000/svg"
          version="1.1"
          id="Layer_2"
          x="0"
          y="0"
          viewBox="0 0 220.5 191"
          enableBackground="new 0 0 220.5 191"
          xmlSpace="preserve"
        >
          <g id="box">
            <polygon
      ...
      <div className="w-full">
        ...
        <button className="button">
          <Link to={`/articles/${id}`}>Read this article</Link>
        </button>
      </div>
    </div>
  );
