    ...
    <div>
      <section className="background-gradient text-white p-8">
        <h2 className="text-5xl lg:text-8xl font-garamond">
          <span style={{ "--delay": 1 }} className="catch text-blue-600">
            S
          </span>
          oftware solutions and i
          <span style={{ "--delay": 0.5 }} className="catch text-blue-600">
            d
          </span>
          eas for purpose driven a
          <span style={{ "--delay": 3 }} className="catch text-blue-600">
            m
          </span>
          bitious companies
        </h2>
      ...
      <section className="p-8 grid md:grid-cols-2 gap-4">
        <div className="max-w-2xl">
          <h3 className="text-4xl md:text-5xl mb-8 font-garamond">
            Hey, my name is <span className="text-blue-600">Milad</span>
          </h3>
          <p className="mb-8">
